...
Die so erhaltene Klassifizierung für jedes Objekt wird mit der \gls{gt} verglichen, um so die Erkennungsrate des Klassifizierers zu ermitteln. Die Konfusionsmatrix ist in Figur \ref{fig:classi_Ex_confMatrix} abgebildet. Die \gls{accuracy} liegt bei 0,5978. \gls{precision} ist 0,5978 \gls{recall} ist 0,5978 \gls{f1score} ist 0,5978

\begin{figure}
\includegraphics[scale=.5]{img/chapter6/classifierRFconf_matrix.png}
\caption[Konfusionsmatrix des RFAnnotators]{Die Konfusionsmatrix für die Klassifikation der Unreal-Bilder durch den RFAnnotator.}
